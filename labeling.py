...
from src.utils import command_arguments_to_run_blind_labeling, command_arguments_to_run_semi_automatic_labeling, command_arguments_to_run_label_cleaning
from src.base.labeling import run_blind_labeling, run_semi_automatic_labeling, run_label_cleaning
...
if __name__ == '__main__':
    ...
    for subject in configuration.SUBJECTS:
        ...
        if command_arguments_to_run_blind_labeling():
            ...
            run_semi_automatic_labeling()

        elif command_arguments_to_run_label_cleaning():
            run_label_cleaning()

        else:
            print('Invalid command arguments')

        # if len(sys.argv) == 1 or (len(sys.argv) == 2 and sys.argv[-1]=='-blind'): # default
        ...
        #         raw_KC_cleaned = clean_annotations(raw_only_KC, thresholds=[0.5, 2.0])
